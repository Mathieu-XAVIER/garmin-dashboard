...
@media (max-width: 768px) {
  ...
  .view-header { flex-direction: column; gap: 12px; align-items: flex-start; margin-bottom: 20px; }
  .view-title { font-size: 20px; }
  .last-night { padding: 8px 12px; }
  .ln-score { font-size: 24px; }
  .kpi-grid { grid-template-columns: repeat(2, 1fr); gap: 8px; }
  .chart-card { padding: 12px 8px 6px; }
  .sleep-table { overflow-x: auto; -webkit-overflow-scrolling: touch; }
