  ...
  <div id="app-shell">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <RouterLink to="/health" class="nav-item" active-class="active">
          <span class="nav-icon">♡</span>
          <span>Santé</span>
        </RouterLink>
        <RouterLink to="/sleep" class="nav-item" active-class="active">
          <span class="nav-icon">◐</span>
          <span>Sommeil</span>
        </RouterLink>
      </nav>
      ...
      <div class="sidebar-footer">
        ...
        <p v-if="store.lastSync" class="last-sync">
          Synchro {{ timeAgo(store.lastSync) }}
        </p>
      </div>
    </aside>
